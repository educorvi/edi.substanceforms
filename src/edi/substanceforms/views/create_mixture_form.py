...
class CreateForm(Form):
    ...
    evaporation_lane_150 = FloatField(u"Verdampfungsfaktor bei 150 °C", render_kw={'class': 'form-control'})
    evaporation_lane_160 = FloatField(u"Verdampfungsfaktor bei 160 °C", render_kw={'class': 'form-control'})
    evaporation_lane_170 = FloatField(u"Verdampfungsfaktor bei 170 °C", render_kw={'class': 'form-control'})
    evaporation_lane_180 = FloatField(u"Verdampfungsfaktor bei 180 °C", render_kw={'class': 'form-control'})
