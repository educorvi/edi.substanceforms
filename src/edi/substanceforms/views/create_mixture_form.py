...
class CreateForm(Form):
    ...
    substance_type = RadioField(u"Art des Wasch- und Reinigungsmittels", [validators.required()], choices=substance_types, render_kw={'class': 'form-control'})
    ...
    checked_emissions = BooleanField(u"Emissionsarmes Produkt", render_kw={'class': 'form-control'})
    flashpoint = IntegerField(u"Flammpunkt", render_kw={'class': 'form-control'})
    values_range = BooleanField(u"Wertebereich", render_kw={'class': 'form-control'})
