...
from edi.substanceforms.helpers import check_value, list_handler, reverse_list_handler, new_list_handler, get_vocabulary, new_list_handler2
    ...
    def submit(self, button):
        ...
        if button == 'Speichern': #and self.validate():
            ...
            for i in self.form.application_areas.data:
                ...
                insertcommand = "INSERT INTO areapairs (area_id, mixture_id) VALUES (%s, %s)" % (int(i), selectedid[0][0])
