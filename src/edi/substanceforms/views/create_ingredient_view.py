...
class CreateIngredientForm(WTFormView):
    ...
    def alreadyselected(self):
        ...
        select = ("SELECT title rchar(50)) || '% )' FROM substance, recipes, substance_mixture WHERE recipes.mixture_id = %s AND substance.substance_id = recipes.substance_id") % itemid
