...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_gefahrstoff_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='gefahrstoff'
        )
        self.assertTrue(view.__name__ == 'gefahrstoff')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in gefahrstoff'
        # )

    def test_gefahrstoff_not_matching_interface(self):
