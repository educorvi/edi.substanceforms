...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_custom_redirect_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='custom-redirect-view'
        )
        self.assertTrue(view.__name__ == 'custom-redirect-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in custom-redirect-view'
        # )

    def test_custom_redirect_view_not_matching_interface(self):
