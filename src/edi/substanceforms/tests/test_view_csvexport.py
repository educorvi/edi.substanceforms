...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_csvexport_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='csvexport'
        )
        self.assertTrue(view.__name__ == 'csvexport')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in csvexport'
        # )

    def test_csvexport_not_matching_interface(self):
