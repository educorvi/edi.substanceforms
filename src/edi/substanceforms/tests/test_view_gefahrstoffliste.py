...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_gefahrstoffliste_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='gefahrstoffliste'
        )
        self.assertTrue(view.__name__ == 'gefahrstoffliste')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in gefahrstoffliste'
        # )

    def test_gefahrstoffliste_not_matching_interface(self):
